...
const CLI_INSTALL_DIR: &str = ".stud/bin";
const CLI_BINARY_NAME: &str = "stud";
...
pub fn install_cli(app: tauri::AppHandle) -> Result<String, String> {
    ...
    // Copy the sidecar binary to the install location
...
pub fn create_command(app: &tauri::AppHandle, args: &str) -> Command {
    ...
    return app
        ...
        .env("STUD_EXPERIMENTAL_ICON_DISCOVERY", "true")
        .env("STUD_EXPERIMENTAL_FILEWATCHER", "true")
        .env("STUD_CLIENT", "desktop")
