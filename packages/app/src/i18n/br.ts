export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Stud",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Stud.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Stud.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Stud.",
  ...
  "dialog.plugins.empty": "Plugins configurados em stud.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Stud este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Stud ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Stud",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (stud.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Stud ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Stud inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Stud",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Stud aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Stud é tematizado.",
