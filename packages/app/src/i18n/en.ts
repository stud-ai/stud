export const dict = {
  ...
  "dialog.provider.stud.note": "Free models included with Stud",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models included with Stud",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Stud.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Stud.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Stud.",
  ...
  "prompt.example.1": "Make a part that changes color when touched",
  "prompt.example.2": "What's the architecture of this project?",
  "prompt.example.3": "Debug why my RemoteEvent isn't firing",
  "prompt.example.4": "Explain how my DataStore module works",
  "prompt.example.5": "Find scripts using deprecated API calls",
  "prompt.example.6": "Add type annotations to this ModuleScript",
  "prompt.example.7": "Refactor this into a clean OOP pattern",
  "prompt.example.8": "What does this error mean?",
  "prompt.example.9": "Help me debug this issue",
  "prompt.example.10": "Create a round system for my experience",
  "prompt.example.11": "Optimize DataStore calls to avoid throttling",
  "prompt.example.12": "Validate RemoteEvent arguments on the server",
  "prompt.example.13": "Create a health bar GUI component",
  "prompt.example.14": "Set up Rojo syncing for this project",
  "prompt.example.15": "Review my code for best practices",
  "prompt.example.16": "Add error handling to this pcall chain",
  "prompt.example.17": "Make a custom character controller",
  "prompt.example.18": "Convert this Script to a ModuleScript",
  "prompt.example.19": "Add analytics tracking throughout the game",
  "prompt.example.20": "What dependencies are outdated?",
  "prompt.example.21": "Help me write a data migration script",
  "prompt.example.22": "Implement a cooldown system for abilities",
  "prompt.example.23": "Add pagination to the inventory UI",
  "prompt.example.24": "Create an admin command system",
  "prompt.example.25": "How does the plugin communicate with Studio?",
  ...
  "dialog.plugins.empty": "Plugins configured in stud.json",
  ...
  "dialog.server.description": "Switch which Stud server this app connects to.",
  ...
  "toast.update.description": "A new version of Stud ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Stud team",
  ...
  "error.chain.checkConfig": "Check your config (stud.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Stud does not support MCP authentication yet.',
  ...
  // New home screen
  "home.tagline": "Cursor for Roblox Studio",
  "home.connectToStudio": "Connect to Roblox Studio",
  "home.connectToStudio.description": "Start coding with AI assistance",
  "home.openRobloxFile": "Open .rbxl File",
  "home.openRobloxFile.description": "Open a local Roblox project file",
  "home.connectViaRojo": "Connect via Rojo",
  "home.connectViaRojo.description": "For projects using Rojo sync",

  // Bridge status
  "bridge.connected": "Connected to Studio",
  "bridge.waiting": "Waiting for Studio...",
  "bridge.notRunning": "Bridge not running",
  "bridge.checking": "Checking connection...",

  // Connect to Studio toast messages
  "home.connectToStudio.success": "Roblox Studio plugin is active and ready",
  "home.connectToStudio.waiting": "Plugin is running but Studio hasn't connected yet. Open Roblox Studio to continue.",
  "home.connectToStudio.error": "Install and enable the Stud plugin in Roblox Studio to connect",
  ...
  "session.new.quickActions": "Quick actions",
  "session.new.quickAction.writeScripts": "Write scripts",
  "session.new.quickAction.writeScripts.prompt": "Write Luau scripts for my game features.",
  "session.new.quickAction.editInstances": "Edit instances",
  "session.new.quickAction.editInstances.prompt": "Edit Roblox instances in my place hierarchy.",
  "session.new.quickAction.searchToolbox": "Search toolbox",
  "session.new.quickAction.searchToolbox.prompt": "Search Roblox Toolbox and suggest assets to insert.",
  "session.new.quickAction.queryDatastores": "Query datastores",
  "session.new.quickAction.queryDatastores.prompt": "Query DataStores and summarize what data is stored.",
  "session.new.quickAction.reviewPermissions": "Review permissions",
  "session.new.quickAction.reviewPermissions.prompt": "Review my current permissions setup and recommend changes.",
  "session.new.quickAction.sendMessage": "Send message",
  "session.new.quickAction.sendMessage.prompt": "Help me plan the next change for this project.",
  ...
  "sidebar.gettingStarted.line1": "Stud includes free models so you can start immediately.",
  ...
  "sidebar.instanceTree.liveChanges": "Live changes",
  "sidebar.instanceTree.liveChanges.empty": "No Roblox actions yet",
  "sidebar.instanceTree.liveChanges.actions": "actions",
  "sidebar.instanceTree.liveChanges.lastSynced": "Last synced",
  "sidebar.instanceTree.liveChanges.notSynced": "Not synced yet",
  "sidebar.instanceTree.liveChanges.justNow": "just now",
  "sidebar.instanceTree.liveChanges.playtestPassed": "playtest passed",
  "sidebar.instanceTree.liveChanges.status.pending": "Pending",
  "sidebar.instanceTree.liveChanges.status.running": "Running",
  "sidebar.instanceTree.liveChanges.status.done": "Done",
  "sidebar.instanceTree.liveChanges.status.failed": "Failed",
  ...
  "settings.general.row.language.description": "Change the display language for Stud",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Stud looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Stud is themed.",
