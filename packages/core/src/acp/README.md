...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for Stud.
...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal Stud sessions
...
- **Terminal Integration**: Full terminal support via Stud's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | stud acp
```
...
ACP sessions map cleanly to Stud's internal session model:
